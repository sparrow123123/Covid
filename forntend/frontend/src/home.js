...
<button onClick={()=>{
    ...
    <div className="dropdown">
      ...
      <div className="dropdown-content">
        ...
        <button id ="vandalur" onClick={()=>{searchdrop('vandalur')}}>vandalur</button>
        <button id ="kundrathur" onClick={()=>{searchdrop('kundrathur')}}>kundrathur</button>
        <button id ="theni" onClick={()=>{searchdrop('theni')}}>theni</button>
        <button id ="chengalpattu" onClick={()=>{searchdrop('chengalpattu')}}>chengalpattu</button>
      </div>
    </div>
    ...
    <div className="dropdown">
      ...
      <div className="dropdown-content">
        <button id="centreid" onClick={()=>{searchdropany('centreid')}}>centreid</button>
        <button id="pincode" onClick={()=>{searchdropany('pincode')}}>pincode</button>
        <button id ="name" onClick={()=>{searchdropany('name')}}>name</button>
