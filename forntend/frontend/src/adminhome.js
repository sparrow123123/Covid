  ...
  return (
    ...
    <div className='option'>
      ...
      <div className='add'>
        ...
        <input style={{marginLeft:"80px"}} type='text' name='name' onChange={e=>setname(e.target.value)} placeholder='Hospital Name' ></input>
        <br></br>
        </div>
        ...
        <label htmlFor='location'> <h3>Enter location</h3></label>
        <input type='text' name='location' onChange={e => setlocation(e.target.value)} placeholder='eg.chennai'/>
        <br></br>
        <label htmlFor='address'><h3>Enter Address </h3></label>
        <input type="" name='address' onChange={e => setaddress(e.target.value)} />
        <br></br>
        <label htmlFor='pincode'><h3>Pincode</h3></label>
        <input type='number' name='pincode' onChange={e=>setpincode(e.target.value)}  ></input>
        <br></br>
          ...
          <div id='additem'>  
        <label htmlFor='openingtime'><h3>Opening Time </h3></label>
        <input  style={{marginLeft:"9px"}}  type='number' name='openingtime' onChange={e => settime(e.target.value)} placeholder='12am-12pm'/>
        <br></br>
        <label htmlFor='closingtime'><h3>closing Time </h3></label>
        <input type='number' name='closingtime' onChange={e=>setclosingtime(e.target.value)} />
        <br></br>
        </div>
        ...
        <div id='additem'>
        <label htmlFor='dosage'><h3>Enter dosage </h3></label>
        <input style={{marginLeft:"19px"}} type='number' name='dosage' onChange={e=>setdosage(e.target.value)} />
   ...
   centres.map((centre)=>(
    <tr key={centre.centreid}>
       <td id='slot'>{centre.centreid}</td>
        ...
        <input id='doscount' type="number" name="doscount"onChange={e=>setdosid(e.target.value)} />
        <button id='dosbtn' onClick={()=>{
           dosadd(centre.centreid,dosid)
        }} >add</button>
        
        </td>
        <td><button id='bookbtn' onClick={()=>{
          slot(centre.centreid)
         
        }}>book</button></td>
        <td><button id='resetbtn' onClick={()=>{
